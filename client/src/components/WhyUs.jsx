          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 h-full">
              ...
              <div className="w-full max-w-md flex justify-end">
                <button
                  onClick={openModal}
                  className="group relative inline-flex items-center gap-2 bg-white hover:bg-gray-100 text-black px-4 py-2 md:px-5 md:py-2.5 rounded-lg font-semibold text-sm transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-white/10"
                >
