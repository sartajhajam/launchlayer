    ...
    <>
      <footer className="bg-[#0F0F11] py-8 px-4 border-t border-gray-800/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button
            onClick={openModal}
            className="group relative inline-flex items-center gap-3 bg-blue-500 hover:bg-blue-600 text-white px-5 py-2.5 md:px-6 md:py-3 rounded-xl font-semibold text-sm md:text-base transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25 mb-6"
          >
          ...
          <div className="flex justify-center items-center space-x-4 mb-6">
            <a
              ...
              className="group flex items-center justify-center w-8 h-8 bg-gray-900/50 border border-gray-800 rounded-lg hover:border-blue-500/50 hover:bg-blue-500/10 transition-all duration-300 hover:scale-110"
            >
